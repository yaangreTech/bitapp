...
/**
     ...
     */
    public function SemesterReport($headers = [], $student_data = [], $className, $semesterNumber, $academicYear, $saveInFolder = ''): void
    {
        ...
        for($col = START_COL+1; $col <= $lastModuleColIndex+1; $col++)//the public function get index removes 1 and returns the result
        {
          $total = 0;
          for($row = STARTING_ROW; $row <= $lastRowIndex; $row++)
          {
