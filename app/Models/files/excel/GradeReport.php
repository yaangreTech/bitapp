...
class GradeReport extends Model
{
    ...
    //public function to reorganize data
    public function ReorganizeData($data): array
    {
        $returnedData = [];
    ...
    //public function to find the
    //public function to apply same formatting for the TU Average, Acquired Credits, TU Validation and Rating since they are the same
    /**
     ...
     */
    public function CellFormat($array, $lastRow, $colStart, $originalData, $currentIndex, $alphabet, $sheet, bool $isTU = false): void
    {
        $row  = $lastRow;
        //tu data
    ...
    //public function to write student info into cells
    public function WriteStudentInfo($sheet, $range, $content, $bgColor = 'ffffffff'): void
    {
        $cells = explode(':', $range);
        $cell = $cells[0];
    ...
    //public function to create cells
    public function CreateCellRange($startCol, $endCol, $row): string
    {
        return $startCol.$row.':'.$endCol.$row;
    }

    //public function to bulk write student info
    public function bulkWriteStudentInfo(ExcelXport $sheet, array $data ,int $row, array $alphabet): void
    {
 ...
 */
public function GradeReport($data, $studentId, $studentSurname, $studentName, $class, $semester, $academicYear, $graduationYear, $academicDirector, $academicDirectorTitle, $saveInFolder = ''): void
{
