<?php
    ...
    function addFonts(): array
    {
        ...
        //adds arial font
        $arial = TCPDF_FONTS::addTTFfont('fonts/Arial.ttf', 'TrueTypeUnicode', '', 96);
        $arial_narrow = TCPDF_FONTS::addTTFfont('fonts/ArialN.ttf', 'TrueTypeUnicode', '', 96);
        $arial_bold = TCPDF_FONTS::addTTFfont('fonts/ArialNB.ttf', 'TrueTypeUnicode', '', 96);
        //helvetica neue
        $helvetica_neue = TCPDF_FONTS::addTTFfont('fonts/helvetica_neue.ttf', 'TrueTypeUnicode', '', 96);
        $helvetica_neue_bold = TCPDF_FONTS::addTTFfont('fonts/helvetica_neue_bold.ttf', 'TrueTypeUnicode', '', 96);
