<?php
    ...
    function Diploma( $lang = "en", $director_full_name = "Dr. W. Rodrigue KABORE", $order_number = '0001', $student_id = 'bs00001', $academic_year = "2020-2021")
    {
        //imports extra fonts
        $fonts = addFonts();
        extract($fonts);
        ...
        //adds rounded arial
        $arial_rounded_bold = TCPDF_FONTS::addTTFfont('./arial_rounded_bold.ttf', 'TrueTypeUnicode', '', 96);        
        ...
        $content = <<<HTML
            ...
            <body>
                <p style="font-weight: bold; text-align: center; font-size: 12px;" class="spacement">
                    ...
                    <img src="logo.png" height="42.7" width="281.02"/>
                </p>
                <table>
                    <tr>
                        <td style="width: 5%"></td>
        ...
        $pdf->Image("./logo.png", 90, 85, 1000, 180, '', '', '', false, 300, '', false, false, 0, false, true, false);
