...
<body class="antialiased">
    <div
        ...
        @if (Route::has('login'))
            <div style="justify-center  sm:items-center align-center ">
                <div class=" welcome_sms">Welcome to bitApp</div>

                <div class=" justify-center  py-4" style="z-index: 100;">

                    <div class=" justify-center sm:items-center align-center startButton">
                        @auth
