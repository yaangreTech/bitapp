<div class="menu">
    <ul class="list">
        ...
        @if (Auth::user()->right->title != 'isCh' && Auth::user()->right->title != 'isha')
            <li >
                <a href="#" onClick="return false;" class="menu-toggle">
        ...
        @endif
          ...
          {{-- Generated documents management menu --}}
          @if (Auth::user()->right->title == 'isha' || Auth::user()->right->title == 'isAdmin')
            <li>
                <a href="#" onClick="return false;" class="menu-toggle">
                    <i class="menu-icon fas fa-file-pdf"></i>
                    <span>Alumnis</span>
                ...
                <ul class="ml-menu">
                    @forelse ($departements as $departement)
                        <li>
                            <a href="{{ route('alumnies')}}" onClick="return true;" class="">
                                <span>{{ $departement->name }}</span>
                            </a>
                        </li>
                    @empty
            ...
            <li>
                ...
                <ul class="ml-menu">
                    <li>
                        <a href="{{ route('newCompany') }}" onClick="return true;" class="">
                            <span>New Company</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('companies') }}" onClick="return true;" class="">
